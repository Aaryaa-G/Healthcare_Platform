...
Date: ${formatDate(prescriptionData.created_at)}
Prescription ID: ${prescriptionData.id}
...
${prescriptionData.instructions ? `SPECIAL INSTRUCTIONS:\n${prescriptionData.instructions}` : ''}

Generated by MedConnect Healthcare Platform
      `;
